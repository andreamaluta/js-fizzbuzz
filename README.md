...
1. scrivo il ciclo per prendere tutti i numeri da 1 a 100
2. controllo se il numero è un multiplo di 3 di 5 o di entrambi
3. in base al confronto scrivo la visualizzazione